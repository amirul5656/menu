...
show_menu() {
    while true; do
        ...
        echo -e "${BLUE}[03]${NC} Remove All Applications ${BLUE}[08]${NC} Disk Usage"
        echo -e "${BLUE}[04]${NC} Service Management     ${BLUE}[09]${NC} Process Monitor"
        echo -e "${BLUE}[05]${NC} System Updates         ${BLUE}[10]${NC} Exit"
        draw_line
        echo
